...
```toml
[dependencies]
iis2dlpc-rs = { version = "2.0.0", default-features = false, features = ["blocking"] }
```
or from the terminal:
```sh
cargo add iis2dlpc-rs --no-default-features --features blocking
```
...
More details and instructions are available in [bsp/README.md](https://github.com/STMicroelectronics/iis2dlpc-rs/blob/main/bsp/README.md).
