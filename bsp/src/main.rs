...
mod mode {
    ...
    pub use iis2dlpc_rs::asynchronous as iis2dlpc;
...
mod mode {
    ...
    pub use iis2dlpc_rs::blocking as iis2dlpc;
    pub use cortex_m_rt::interrupt;
}

pub use mode::*;
pub use iis2dlpc::I2CAddress;
...
#[cfg(feature = "tap_single")]
mod examples {
    mod tap_single;
    pub use tap_single::run;
}

// Double tap detection
#[cfg(feature = "tap_double")]
mod examples {
    mod tap_double;
    pub use tap_double::run;
}
